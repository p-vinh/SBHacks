...
# Change bucket_name to whatever we name bucket in the cloud

bucket_name = 'nutribot_data_bucket'
...
file_path = r'template\user-data'

upload_to_bucket('sadsss.json', os.path.join(file_path, 'sadsss.json'), bucket_name)
...
download_file_from_bucket('sadsss.json', os.path.join(file_path, 'sadsss.json'), bucket_name)
